...
<head>
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/6.2.7/css/tempus-dominus.min.css"
        integrity="sha512-B9HdJLfCGrcIRpeqMGMCS0GXyG+4v3S22KlZA8Mxj10B8rj/JPibp2bIMYzfZ1MWAIn1n7MOb8UgYNcPJ1+oZA=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    @stack('styles')
    @livewireStyles
</head>
                                        ...
                                        @if (Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent">
                                                ...
                                                <ul class="submenu curency">
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="homeslider" href="{{ route('admin.homeslider') }}">Home
                                                            Slider</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="homecategory"
                                                            href="{{ route('admin.homecategory') }}">Manager Home
                                                            Category</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="sales" href="{{ route('admin.sales') }}">Sales
                                                            Setting</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Dashboard" href="{{ route('admin.dashboard') }}">Admin
