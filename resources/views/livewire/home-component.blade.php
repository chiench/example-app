                                ...
                                <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><ins>
                                                    <p class="product-price">${{$item->regular_price - $item->sale_price}}.00</p>
                                                </ins> <del>
                                ...
                                <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="detail.html"
                                                title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                                <figure><img src="{{asset('assets/images/products')}}/{{$subproduct->image}}"
                                                        width="800" height="800"
                                                        alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                            </a>
                                            <div class="group-flash">
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>{{$subproduct->name}}</span></a>
                                            <div class="wrap-price"><span class="product-price">${{$subproduct->regular_price}}</span></div>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
