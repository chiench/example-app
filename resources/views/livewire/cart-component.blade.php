            ...
            <div class=" main-content-area">
                            ...
                            <div class="quantity">
                                <div class="quantity-input">
                                    <input type="text" name="product-quatity" value="{{$item->qty }}" data-max="120"
                                        pattern="[0-9]*">
                                    <a class="btn btn-increase" wire:click.prevent="addqty('{{$item->rowId}}')" href="#"></a>
                                    <a class="btn btn-reduce" wire:click.prevent="minusqty('{{$item->rowId}}')" href="#"></a>
                                </div>
                            </div>
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        <p class="summary-info"><span class="title">Tax (21%)</span><b class="index">${{Cart::tax()}}</b>
                        </p>
                    ...
                    <div class="update-clear">
                        <a class="btn btn-clear"  wire:click.prevent="removeallitem()" href="#">Clear Shopping Cart</a>
