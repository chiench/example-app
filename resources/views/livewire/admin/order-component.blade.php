                                    ...
                                    <tr>
                                        ...
                                        <td class='text-center'>
                                            @if ($item->status == 'ordered')
                                                <a href=""
                                                    wire:click.prevent="updateDeliverdOrderStatus({{ $item->id }})"
                                                    class="btn btn-primary btn-sm ">
                                                    Deliverd
                                                </a>
                                            @endif
                                            @if (!$item->status == 'canceled' || $item->status == 'ordered')
                                                <a href=""
                                                    wire:click.prevent="updateCanceledOrderStatus({{ $item->id }})"
                                        ...
                                        <td class="text-right">
                                            <a name="" id="" class="btn btn-sm btn-success"
                                                href="{{ route('admin.orders.details', ['order_id' => $item->id]) }}"
                                                role="button">
