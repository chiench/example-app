        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                     <!-- Search -->
                    <div style="display:flex; justify-content: space-between;align-items: center;" class="panel-heading">Edit Homeslider
                        <div class="search">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent='updateHomeSlider'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 d-flex flex-row">
                                    <input type="file" wire:model='newImage' class="input-file" id="image">
                                    @if ($image)
                                        @if ($newImage)
                                        <img src="{{$newImage->temporaryUrl()}}"  style="margin-top: 25px;" height="200" width="200" alt="">
                                        @else
                                        <img  style="margin-top: 25px;" height="200" width="200" src="{{asset('assets/images/sliders')}}/{{$image}} ">
                                        @endif
                                    @else
                                        @if ($newImage)
                                        <img src="{{$newImage->temporaryUrl()}}"  style="margin-top: 25px;" height="200" width="200" alt="">
