                    ...
                    <div
                        ...
                        <div class="search">
                            @if ($orders->status !== 'canceled')
                                <a wire:click.prevent='updateCanceledOrderStatus({{ $orders->id }})' href=""
                                    style="margin-right: 10px" class="btn btn-warning">
                                    Cancel</a>
                            @endif


                            <a href="{{ route('user.orders') }}" class="btn btn-danger"> All
                                Orders</a>
                        </div>
                    </div>
